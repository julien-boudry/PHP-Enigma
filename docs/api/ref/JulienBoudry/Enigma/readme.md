...
| [EnigmaAlphabet](EnigmaAlphabet/class_EnigmaAlphabet.md) | _The Enigma machine uses a 26-letter alphabet (A-Z) for all encryption operations. This class provides the mapping between integer key codes and their corresponding letters._ |
