> JulienBoudry \ [Enigma](../../readme.md) \ **ReflectorC**
# Class ReflectorC
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Reflector/ReflectorC.php#L12)
...
```php
final class JulienBoudry\Enigma\Reflector\ReflectorC extends JulienBoudry\Enigma\Reflector\AbstractReflector
{
