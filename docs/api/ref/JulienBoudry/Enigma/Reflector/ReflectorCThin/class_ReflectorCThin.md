> JulienBoudry \ [Enigma](../../readme.md) \ **ReflectorCThin**
...
```php
final class JulienBoudry\Enigma\Reflector\ReflectorCThin extends JulienBoudry\Enigma\Reflector\AbstractReflector
{
