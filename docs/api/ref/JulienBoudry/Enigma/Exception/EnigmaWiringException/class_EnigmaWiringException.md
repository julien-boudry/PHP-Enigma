> JulienBoudry \ [Enigma](../../readme.md) \ **EnigmaWiringException**
...
```php
class JulienBoudry\Enigma\Exception\EnigmaWiringException extends Exception implements Throwable, Stringable
{
