> JulienBoudry \ [Enigma](../../readme.md) \ **EnigmaConfigurationException**
...
```php
class JulienBoudry\Enigma\Exception\EnigmaConfigurationException extends Exception implements Throwable, Stringable
{
