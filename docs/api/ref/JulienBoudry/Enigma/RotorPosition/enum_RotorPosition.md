...
| ------------- | ------------- | ------------- |
| GREEK | `public const GREEK = \JulienBoudry\Enigma\RotorPosition::GREEK` | _This rotor never rotates. Only BETA and GAMMA rotors can be mounted here._ |
| P1 | `public const P1 = \JulienBoudry\Enigma\RotorPosition::P1` | _Rotates on every keypress._ |
| P2 | `public const P2 = \JulienBoudry\Enigma\RotorPosition::P2` | _Rotates when P1 reaches its notch, or due to double-stepping when P3 rotates._ |
| P3 | `public const P3 = \JulienBoudry\Enigma\RotorPosition::P3` | _Rotates when P2 reaches its notch._ |
