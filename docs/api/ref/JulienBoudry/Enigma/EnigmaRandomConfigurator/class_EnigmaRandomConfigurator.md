...
```php
final class JulienBoudry\Enigma\EnigmaRandomConfigurator
{

    // Methods
    public function __construct( [ ?Random\Engine $engine = null ] );
    public function generate( JulienBoudry\Enigma\EnigmaModel $model ): JulienBoudry\Enigma\EnigmaConfiguration;
