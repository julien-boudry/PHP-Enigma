> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorBeta**
# Class RotorBeta
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorBeta.php#L15)

## Description
Rotor Beta - Greek rotor for Kriegsmarine M4 only.
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorBeta extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
