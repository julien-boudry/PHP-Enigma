> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorTirpitzIV**
# Class RotorTirpitzIV
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorTirpitzIV.php#L15)

## Description
Rotor IV for Enigma T (Tirpitz).
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorTirpitzIV extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
