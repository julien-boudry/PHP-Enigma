> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorSwissKIII**
# Class RotorSwissKIII
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorSwissKIII.php#L16)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorSwissKIII extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
