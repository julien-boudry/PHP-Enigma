> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorTirpitzIII**
# Class RotorTirpitzIII
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorTirpitzIII.php#L15)

## Description
Rotor III for Enigma T (Tirpitz).
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorTirpitzIII extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
