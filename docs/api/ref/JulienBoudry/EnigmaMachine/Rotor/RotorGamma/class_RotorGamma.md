> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorGamma**
# Class RotorGamma
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorGamma.php#L15)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorGamma extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
