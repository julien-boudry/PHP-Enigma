> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorII**
# Class RotorII
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorII.php#L14)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorII extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
