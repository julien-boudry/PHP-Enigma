> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorRailwayI**
# Class RotorRailwayI
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorRailwayI.php#L18)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorRailwayI extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
