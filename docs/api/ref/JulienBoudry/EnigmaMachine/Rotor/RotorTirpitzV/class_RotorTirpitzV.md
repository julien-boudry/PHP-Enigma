> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorTirpitzV**
# Class RotorTirpitzV
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorTirpitzV.php#L15)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorTirpitzV extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
