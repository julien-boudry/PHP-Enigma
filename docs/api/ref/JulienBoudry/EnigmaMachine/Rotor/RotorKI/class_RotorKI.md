> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorKI**
# Class RotorKI
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorKI.php#L16)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorKI extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
