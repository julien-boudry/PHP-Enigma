> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorVI**
# Class RotorVI
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorVI.php#L14)

## Description
Rotor VI - Available on Kriegsmarine M3 and M4 only.
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorVI extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
