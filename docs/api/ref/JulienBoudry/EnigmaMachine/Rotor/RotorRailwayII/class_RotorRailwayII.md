> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorRailwayII**
# Class RotorRailwayII
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorRailwayII.php#L18)
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorRailwayII extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
