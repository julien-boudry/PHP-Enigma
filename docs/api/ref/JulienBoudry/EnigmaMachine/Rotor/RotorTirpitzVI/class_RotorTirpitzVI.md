> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorTirpitzVI**
# Class RotorTirpitzVI
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorTirpitzVI.php#L15)

## Description
Rotor VI for Enigma T (Tirpitz).
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorTirpitzVI extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
