> JulienBoudry \ [EnigmaMachine](../../readme.md) \ **RotorTirpitzI**
# Class RotorTirpitzI
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Rotor/RotorTirpitzI.php#L15)

## Description
Rotor I for Enigma T (Tirpitz).
...
```php
final class JulienBoudry\EnigmaMachine\Rotor\RotorTirpitzI extends JulienBoudry\EnigmaMachine\Rotor\AbstractRotor
{
