...
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Enigma.php#L376)
...
## Related
- **[\JulienBoudry\EnigmaMachine\EnigmaTextConverter::latinToEnigmaFormat()](../EnigmaTextConverter/method_latinToEnigmaFormat.md)** _For the conversion rules_
