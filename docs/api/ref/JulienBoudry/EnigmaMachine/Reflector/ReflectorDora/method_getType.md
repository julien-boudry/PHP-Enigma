...
# Method getType()
> [Read it at source](https://github.com/julien-boudry/PHP-Enigma/tree/master/src/Reflector/ReflectorDora.php#L180)

```php
public function ReflectorDora->getType( ): JulienBoudry\EnigmaMachine\ReflectorType
```
